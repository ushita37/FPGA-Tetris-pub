...
HD_PWD='C:/Users/user/Downloads/Jikken2_FPGA/sound/sound.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soundtop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soundtop.tcl
