...
HD_PWD='C:/Users/user/Downloads/Jikken2_FPGA/sound/sound.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soundtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soundtop.tcl -notrace
