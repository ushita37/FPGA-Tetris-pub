...
HD_PWD='C:/Users/ushit/iCloudDrive/Documents/UEC-B2/JK-lab/FPGA-Tetris/tetris-hi-res/tetris-hi-res.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log video.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source video.tcl -notrace
