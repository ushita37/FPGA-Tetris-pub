...
HD_PWD='C:/Users/ushit/iCloudDrive/Documents/UEC-B2/JK-lab/FPGA-Tetris/tetris-hi-res/tetris-hi-res.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video.tcl
